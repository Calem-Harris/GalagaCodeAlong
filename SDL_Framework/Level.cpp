...
Level::Level(int stage, PlaySideBar* sideBar, Player* player) {
	...
	mStageLabel = new SDLTexture("STAGE", "emulogic.ttf", 32, { 75, 75, 200 });
	...
	mReadyLabel = new SDLTexture("READY", "emulogic.ttf", 32, { 150, 0, 0 });
	...
	mGameOverLabel = new SDLTexture("GAME OVER!", "emulogic.ttf", 32, { 150, 0 ,0 });
